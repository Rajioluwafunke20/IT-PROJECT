        ...
        <div class="hero-visuals">
          <div class="product-showcase" data-aos="fade-left" data-aos-delay="200">
            <div class="product-card featured">
              ...
              <div class="product-info">
                <h4>Premium Comfortable Chair</h4>
                <div class="price">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              ...
              <div class="product-info">
                ...
                <h4 class="product-name"><a href="product-details.php">Luxury Leather Bag </a></h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              ...
              <div class="product-info">
                ...
                <h4 class="product-name"><a href="product-details.php">SweatShirts </a></h4>
                <div class="product-rating">
                  <div class="stars">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              ...
              <div class="product-info">
                ...
                <h4 class="product-name"><a href="product-details.php">Unisex Jean Jacket </a></h4>
                <div class="product-rating">
                  <div class="stars">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              ...
              <div class="product-info">
                ...
                <h4 class="product-name"><a href="product-details.php">Men's Wear </a></h4>
                <div class="product-rating">
                  <div class="stars">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
