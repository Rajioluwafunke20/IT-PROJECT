            ...
            <div class="dropdown account-dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <div class="dropdown-footer">
                  <a href="register.php" class="btn btn-primary w-100 mb-2">Sign In</a>
                  <a href="login.php" class="btn btn-outline-primary w-100">Register</a>
                </div>
              </div>
            </div>
  ...
  <main class="main">
    ...
    <section id="about-2" class="about-2 section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h2 class="about-title">Welcome to Nova Couture, where fashion meets confidence.</h2>
            <p class="about-description">We are more than just a clothing brand — we are a lifestyle. Our mission is to create timeless and trendy pieces that make every individual feel stylish, comfortable, and empowered.</p>
          </div>
          <div class="col-lg-6">
            <p class="about-text">we started with a simple idea: to design quality clothing that speaks to personality, creativity, and elegance. From everyday essentials to bold statement outfits, every piece in our collection is carefully crafted with attention to detail, comfort, and durability.</p>
