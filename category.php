              ...
              <div class="row g-4">
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in">
                    ...
                    <div class="product-details">
                      ...
                      <h4 class="product-title"><a href="product-details.php">Tempor Incididunt</a></h4>
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="product-details">
                      ...
                      <h4 class="product-title"><a href="product-details.php">Elit Consectetur</a></h4>
                      <div class="product-meta">
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <div class="product-details">
                      ...
                      <h4 class="product-title"><a href="product-details.php">Adipiscing Magna</a></h4>
                      <div class="product-meta">
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <div class="product-details">
                      ...
                      <h4 class="product-title"><a href="product-details.php">Labore Dolore</a></h4>
                      <div class="product-meta">
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <div class="product-details">
                      ...
                      <h4 class="product-title"><a href="product-details.php">Magna Aliqua</a></h4>
                      <div class="product-meta">
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="500">
                    ...
                    <div class="product-details">
                      <div class="product-category">Women's Fashion</div>
                      <h4 class="product-title"><a href="product-details.php">Eiusmod Tempor</a></h4>
                      <div class="product-meta">
                        <div class="product-price">
                          $110.00
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="600">
                    ...
                    <div class="product-details">
                      <div class="product-category">Accessories</div>
                      <h4 class="product-title"><a href="product-details.php">Incididunt Labore</a></h4>
                      <div class="product-meta">
                ...
                <div class="col-6 col-xl-4">
                  <div class="product-card" data-aos="zoom-in" data-aos-delay="700">
                    ...
                    <div class="product-details">
                      <div class="product-category">Men's Fashion</div>
                      <h4 class="product-title"><a href="product-details.php">Aliqua Magna</a></h4>
                      <div class="product-meta">
